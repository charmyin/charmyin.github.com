...
出自： [http://www.undefinenull.com](http://www.undefinednull.com/2014/02/11/mastering-the-scope-of-a-directive-in-angularjs/)

翻译者： [Charmyin](http://charmyin.github.io/)
...
Directives 是Angularjs一种强大的特性。你可以将它们想象成任何Angularjs应用的建造块（As known as, 可重复利用的模块）；掌握所有directives已经完全超出了本文的范畴。因此，我相当推荐一本书，它包括任何你想知道的关于Angularjs的东西。这里，我们将讨论Directives的一个方面：“Directive Scope（Directive 作用域）”
